          ...
          <div className="flex items-center mt-4">
            ...
            <div className="flex gap-4">
              {social.map((service, index) => (
                ...
                >
                  {/*
                    If you get the TypeScript error '...expression of type string cannot be used to index...'
                    then specify that the 'expression of type string' is a key of the type of that object.
                  */}
